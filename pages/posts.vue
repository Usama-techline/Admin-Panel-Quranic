...
<div style="margin:50px">
   <h3 style="margin-bottom:20px;text-align:center;">Add Post</h3>
   <div>
     ...
     async onSubmit()
      {
       ...
       fd.append('category',this.categ)
        ...
        console.log(this.file)
         await this.$axios.post('http://127.0.0.1:8000/api/post/store',fd)
     .then(response => {
       if(response.data.status=='Post Created Sucesfully!')
       {
